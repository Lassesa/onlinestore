...
router.post('/',function(request,response){ //käytä postia kun teet uusia tunnuksia loginiin
...
function createToken(username, role){
    return jwt.sign({username, role}, process.env.MY_TOKEN,{expiresIn:'1200s'}); //token vanhenee 20minuutissa
}
